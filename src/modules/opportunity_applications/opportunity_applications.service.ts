...
export class OpportunityApplicationService {
  ...
  //         qb.orderBy('application.created_at', query.order || 'DESC');
  //       } else if (query.orderBy === 'updated_at') {
  //         qb.orderBy('application.updated_at', query.order || 'DESC');
  //       } else if (query.orderBy === 'opportunity_title') {
  //         qb.orderBy('opportunity.title', query.order || 'ASC');
  //       } else if (query.orderBy === 'status_name') {
  //         qb.orderBy('status.status', query.order || 'ASC');
  //       }
  //     } else {
  ...
  //         // Ensure applied_skills is treated as an array
  ...
  //       (app as any)['applied_skills_details'] = appliedSkillDetails; // Add skills details field
  //     }
